...
@Component({
    selector: 'app-chamsockhachhang-cmp',
    templateUrl: './ChamSocKhachHang.component.html'
})

export class ChamSocKhachHangComponent implements OnInit , AfterViewInit {
    ...
    ngAfterViewInit() {
        ...
        const table2 = $('#lichsumuahang').DataTable();
